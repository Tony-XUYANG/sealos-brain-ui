...
当前发布版本为 `v1.1.0`。线上演示已部署到 [Sealos Cloud](https://sealos-brain-ui-dinkkees.sealoshzh.site)，对应公开镜像为 `ghcr.io/tony-xuyang/sealos-brain-ui:20260826-214738`。
...
- 故障区 3 条动态连接粒子、AI Proxy 到 7 个模型的独立粒子路径，以及 Skills 的 4 条输入粒子与 1 条输出粒子
- 顶部、主部署区、App Store 与页尾部署入口统一使用设计稿中的火箭图标
- Scale 数字动画与移动菜单
...
The current release is `v1.1.0`. The accepted build is live on [Sealos Cloud](https://sealos-brain-ui-dinkkees.sealoshzh.site) and uses the public image `ghcr.io/tony-xuyang/sealos-brain-ui:20260826-214738`.
...
- Three moving issue-route particles, independent routes to all seven AI providers, and four Skills input particles plus one output particle
- Design-matched rocket icons across the header, primary Deploy form, App Store, and footer deployment actions
